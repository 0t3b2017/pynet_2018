...
Try to use re.DOTALL flag as part of your search. Your search pattern should not include any of the literal 
characters in the IPv6 address.
...
# From this file, use Python regular expressions to extract the two IPv6 addresses.
ipv6_addr = re.search(r'IPv6 address:.* ([\w:\/]+) .* ([\w:\/]+).*IPv6 subnet:', show_ipv6, re.DOTALL)
print(ipv6_addr.group(1))
print(ipv6_addr.group(2))
